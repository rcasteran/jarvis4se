...
def cut_string_list(string_tuple_list):
    ...
    From a list of input strings containing {(element_A, [element_B, element_C])}, returns a list of combined strings
    containing {(element_A, element_B), (element_A, element_C)}.
