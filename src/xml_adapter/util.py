...
XML_DICT_KEY_9_ACTIVITY_LIST = 'xml_activity_list'
XML_DICT_KEY_10_INFORMATION_LIST = 'xml_information_list'
XML_DICT_KEY_11_ATTRIBUTE_LIST = 'xml_attribute_list'
XML_DICT_KEY_12_VIEW_LIST = 'xml_view_list'
XML_DICT_KEY_13_TYPE_LIST = 'xml_type_list'
XML_DICT_KEY_14_FUN_CONS_LIST = 'xml_consumer_function_list'
XML_DICT_KEY_15_FUN_PROD_LIST = 'xml_producer_function_list'
XML_DICT_KEY_16_ACT_CONS_LIST = 'xml_consumer_activity_list'
XML_DICT_KEY_17_ACT_PROD_LIST = 'xml_producer_activity_list'
